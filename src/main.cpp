...
const int L1_Max = 7000;
const int R1_Max = 7280;
const int L2_Max = 7015;
const int R2_Max = 7100;

volatile long L1_encoderPos = 0;
volatile long L1_last_encoderPos = 0;
volatile long R1_encoderPos = 0;
volatile long R1_last_encoderPos = 0;
volatile long L2_encoderPos = 0;
volatile long L2_last_encoderPos = 0;
volatile long R2_encoderPos = 0;
volatile long R2_last_encoderPos = 0;
...
int PID_output(long encoderPos_Max, double middle_encoderPos, long new_encoderPos)
{
  int PID_out = 255.0 / encoderPos_Max * (middle_encoderPos - new_encoderPos);
  return PID_out;
}
...
void L1_forward_Task(void *pvParameters)
{
  while (1)
  {
...
void L1_backward_Task(void *pvParameters)
{
  while (1)
  {
...
void R1_forward_Task(void *pvParameters)
{
  while (1)
  {
...
void R1_backward_Task(void *pvParameters)
{
  while (1)
  {
...
void L2_forward_Task(void *pvParameters)
{
  while (1)
  {
...
void L2_backward_Task(void *pvParameters)
{
  while (1)
  {
...
void R2_forward_Task(void *pvParameters)
{
  while (1)
  {
...
void R2_backward_Task(void *pvParameters)
{
  while (1)
  {
...
void allstop_Task(void *pvParameters)
{
  while (1)
  {
    if (allstop_Status)
...
void setup()
{
  xTaskCreate(allstop_Task, "通过PID+编码器检测速度", 1000, NULL, 1, NULL);
  ...
  xTaskCreate(L1_forward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(L1_backward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(R1_forward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(R1_backward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(L2_forward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(L2_backward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(R2_forward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
  xTaskCreate(R2_backward_Task, "通过PID+编码器检测速度", 1000, NULL, 3, NULL);
